  ...
  void listCurrentShifts() {
    ...
    for (int i = 0; i < shifts.length; i++) {
      if (!shifts[i].isDeleted) {
        print("${i + 1}. ${shifts[i].name} - ${shifts[i].date} at ${shifts[i].time}");
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => Update(service: service,)));
                },
            ...
            ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Restore(service: service,)));
                },
